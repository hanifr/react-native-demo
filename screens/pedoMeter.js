...
const styles = StyleSheet.create({
  ...
  cardtop:{height:"25%", backgroundColor:"gray", width:"99%", alignItems: 'center',
  ...
  cardCenter:{height:"50%", backgroundColor:"gray", width:"99%", alignItems: 'center',
  justifyContent: 'center', marginTop:5,padding:5, borderRadius: 5, borderColor: '#ccc',
  },
  cardbottom:{height:"20%", backgroundColor:"gray", width:"99%", alignItems: 'center',
